...
# l1 =   Line.new([70, 250],[30, 450])
# l2 = Line.new([20, 420],[150, 250]) 
# l3 = Line.new([15,200], [100,400])

# i = l1.intersections([l1, l2, l3])
# puts i
# ii = l1.split_by_lines([l2, l3])
# puts ii

# puts d.lines
# puts d.points

# d.elements += [l1, l2, l3, ii].flatten
